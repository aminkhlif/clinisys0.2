...
function SousMenuItem({ sousMenu, selectionne, onSelect, onEdit, onDelete }) {
  return (
      ...
      sx={{
        ...
        borderRadius: 1.5,
        mb: 0.25,
        borderLeft: selectionne ? '3px solid #000000' : '3px solid transparent',
        color: selectionne ? 'text.primary' : 'text.secondary',
        bgcolor: selectionne ? 'action.selected' : 'transparent',
        '&:hover': {
          bgcolor: selectionne ? 'action.selected' : 'action.hover',
        },
        '&.Mui-selected': {
